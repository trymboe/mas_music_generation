...
# Hyperparameters
D_EMBED_DRUM = 512  # Dimention of embeded layer
D_MODEL_DRUM = 512  # Dimention of model
D_HEAD_DRUM = 64  # Dimention of each attention head
D_INNER_DRUM = 2048  # Dimension of inner hidden size in positionwise feed-forward
DROPOUT_DRUM = 0.2  # Dropout rate
DROPATT_DRUM = 0.1  # Attention dropout rate
NUM_LAYERS_DRUM = 12  # Number of layers
