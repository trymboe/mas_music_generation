...
from bumblebeat.bumblebeat.utils.data import split_range, create_dir_if_not_exists
from bumblebeat.bumblebeat.utils.generation import TxlSimpleSampler
...
def accompany_sequence(
    model, seq, silence_tokens, gen_len, temp, topk, mem_len, device
):
    """
